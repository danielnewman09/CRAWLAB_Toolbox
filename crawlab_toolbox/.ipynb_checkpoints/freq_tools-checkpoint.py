...
def csd(x, y, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,
    ...
    return freqs, Pxy, Std

def generateFFT(inputData,fs,nperseg,averaged=True):
    ...
    FFTStd = np.std(FFTMag.real,axis=-1).flatten()
    ...
    return FFTFreq.flatten(), FFTMag.real, FFTStd
